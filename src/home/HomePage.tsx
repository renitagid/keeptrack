...
function HomePage() {
  return (
    <div style={{backgroundImage:"url(assets/landingpage.jpeg)", backgroundRepeat:"no-repeat", backgroundSize:"100%, 100%", objectFit:"cover", height:"90vh", width:"100%", paddingTop:10, textAlign:"center"}}>
